    ...
    def _create_options_panel(self) -> QWidget:
        ...
        if hasattr(self.gui_state, "release_notes_display_option"):
            ...
            if option == ReleaseNotesDisplayOption.SHOW_ON_STARTUP.value:
                ...
                self.radio_startup.setChecked(True)  # Default
        else:
            self.radio_startup.setChecked(True)  # Default
...
if __name__ == "__main__":
    ...
    # Update GuiState to include the new release_notes_display_option field
    gui_state = GuiState()
    gui_state.release_notes_display_option = ReleaseNotesDisplayOption.SHOW_ON_STARTUP.value

...
RAW_MEDIAPIPE_FULL_REPROJECTION_ERROR_NPY_FILE_NAME = (
    "mediapipe3dData_numCams_numFrames_numTrackedPoints_reprojectionError.npy"
)

REPROJECTION_FILTERED_MEDIAPIPE_3D_NPY_FILE_NAME = (
    "reprojection_filtered_mediapipe3dData_numFrames_numTrackedPoints_spatialXYZ.npy"
)
REPROJECTION_FILTERED_MEDIAPIPE_REPROJECTION_ERROR_NPY_FILE_NAME = (
    "reprojection_filtered_mediapipe3dData_numFrames_numTrackedPoints_reprojectionError.npy"
)
REPROJECTION_FILTERED_MEDIAPIPE_FULL_REPROJECTION_ERROR_NPY_FILE_NAME = (
    "reprojection_filtered_mediapipe3dData_numCams_numFrames_numTrackedPoints_reprojectionError.npy"
)

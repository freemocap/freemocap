...
from freemocap.core.tasks.calibration_task.v1_capture_volume_calibration.anipose_camera_calibration.anipose_camera_calibrator import \
...
def run_anipose_capture_volume_calibration(
    ...
    anipose_camera_calibrator = AniposeCameraCalibrator(
        ...
        calibration_recording_folder=calibration_recording_folder,

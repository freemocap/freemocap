...
18. [ ] **FMC-WS-3** — `StreamSchema.from_standard_human()` against the six-group layout
        ([`09-standard-stream-protocol`](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels)): ChannelKind rewrite
...
same computation") makes it mandatory; [`13`](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md) § Remaining work and

...
from freemocap.zzold.data_layer.skeleton_models.marker_info import MarkerInfo
from freemocap.zzold.data_layer.skeleton_models.segments import Segment, SegmentAnthropometry
from freemocap.zzold.data_layer.skeleton_models.skeleton import Skeleton

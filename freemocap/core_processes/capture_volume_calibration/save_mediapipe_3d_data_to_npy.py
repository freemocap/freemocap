...
from freemocap.system.paths_and_filenames.file_and_folder_names import RAW_MEDIAPIPE_3D_NPY_FILE_NAME, \
    RAW_MEDIAPIPE_REPROJECTION_ERROR_NPY_FILE_NAME, REPROJECTION_FILTERED_MEDIAPIPE_3D_NPY_FILE_NAME, \
...
def save_mediapipe_3d_data_to_npy(
    ...
    if processing_level == "raw":
        ...
        mediapipe_3dData_save_path = path_to_folder_where_data_will_be_saved / REPROJECTION_FILTERED_MEDIAPIPE_3D_NPY_FILE_NAME
        mediapipe_reprojection_error_save_path = (

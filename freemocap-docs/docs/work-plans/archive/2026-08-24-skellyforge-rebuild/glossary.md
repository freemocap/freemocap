...
The vocabulary shared across every layer, grounded in [the ontology](../2026-08-17-message-model-cutover/ontology.md). The seven layers
...
## Data (the seven layers — see [ontology.md](../2026-08-17-message-model-cutover/ontology.md))
...
> [ontology.md](../2026-08-17-message-model-cutover/ontology.md). Twist at the *segment* level is still own-geometry-or-damped.

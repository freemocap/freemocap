...
> ([12](../streaming-compatibility-specs/12-standard-human-model.md)) and a strict keypoint/landmark/segment vocabulary
> ([13](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md)). `canonical_body.yaml` and its consumers **predate that
...
dotted-string hierarchy [10](../streaming-compatibility-specs/10-serialization-and-tidy-format.md) already flags as a pain point in the
parquet schema.
...
[13](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md) replaced. Landmarks are *fitted*; "tracked point" says
measured.
...
| `core/tasks/mocap/streaming_kinematics.py`, `body_kinematics_state.py` | 133 | Disabled centroidal path (`[LATER]`, [06](../streaming-compatibility-specs/06-backend-refactor-and-cleanup.md)) |
...
([07](../streaming-compatibility-specs/07-coordinate-conventions.md#subject-relative-constructions)). Rebuilding from mirrored positions
...
[14 §7](../streaming-compatibility-specs/14-engine-testing-strategy.md#7-standard-human-model).
...
([01](../streaming-compatibility-specs/01-canonical-data-model.md#multi-subject-from-day-one)) indexes such a list; it does not reach
into the model.
...
([13](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md)); trajectory data attaches to the resolved skeleton by
...
1. [ ] **Agree the target shape above**, and record the decisions in
       [12](../streaming-compatibility-specs/12-standard-human-model.md) / [13](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md).
...
8. [ ] **Tests** — model-integrity tests per [14](../streaming-compatibility-specs/14-engine-testing-strategy.md) §7: every segment's
...
[12](../streaming-compatibility-specs/12-standard-human-model.md) still specifies a **singular** SC joint and needs revising to bilateral.

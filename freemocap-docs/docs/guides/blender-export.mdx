...
Blender export currently works with **MediaPipe** mocap output only — RTMPose 3D data does not yet have a working Blender export. See the [Post-Hoc Motion Capture guide](/docs/guides/posthoc-mocap).
:::

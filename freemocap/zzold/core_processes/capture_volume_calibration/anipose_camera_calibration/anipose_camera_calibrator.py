...
import \
    freemocap.zzold.core_processes.capture_volume_calibration.anipose_camera_calibration.anipose_stuff.anipose_charuco_board
from freemocap.zzold.core_processes.capture_volume_calibration.charuco_stuff.charuco_board_definition import (
...
class AniposeCameraCalibrator:
    ...
    def _initialize_anipose_objects(self):
        ...
        self._anipose_charuco_board = freemocap.old.core_processes.capture_volume_calibration.anipose_camera_calibration.anipose_stuff.anipose_charuco_board.AniposeCharucoBoard(

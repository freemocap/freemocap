...
class SCSSFileWatcher(QFileSystemWatcher):
    def __init__(self, path_to_scss_file: Union[str, Path], parent=None):
...
if __name__ == "__main__":
    ...
    qt_file_system_watcher = SCSSFileWatcher(path_to_scss_file=Path(__file__).parent / "qt_style_sheet.scss")

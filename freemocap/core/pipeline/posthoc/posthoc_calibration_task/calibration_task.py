...
from freemocap.core.pipeline.posthoc.posthoc_calibration_task.anipose_calibration.run_anipose_calibration import (
...
from freemocap.core.pipeline.posthoc.posthoc_calibration_task.pyceres_calibration.helpers.toml_io import (
    save_calibration_toml,
)
from freemocap.core.pipeline.posthoc.posthoc_calibration_task.pyceres_calibration.pyceres_calibration_pipeline import (
    run_pyceres_calibration,
)
from freemocap.core.pipeline.posthoc.posthoc_calibration_task.shared.calibration_paths import \
    create_camera_calibration_file_name, get_last_successful_calibration_toml_path
from freemocap.core.pipeline.posthoc.posthoc_calibration_task.shared.calibration_save import (
    save_calibration_copies,
)
from freemocap.core.pipeline.posthoc.posthoc_calibration_task.shared.charuco_model_from_observations import \
...
def _run_pyceres_path(
    *,
    ...
    recording_toml = save_calibration_copies(
        save_fn=lambda path: save_calibration_toml(result=result, path=path, metadata=metadata),
        recording_name=recording_info.recording_name,

...
if __name__ == "__main__":
    ...
    data_2d_path = recording_folder / "output_data" / "raw_data" / "mediapipe_2dData_numCams_numFrames_numTrackedPoints_pixelXY.npy"
    ...
    print(f"\tTotal triangulation time is: {np.mean(times)} seconds for {data_2d.shape[1]} frames over {num_trials} runs")

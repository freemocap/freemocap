...
class RecordVideos(QWidget):
    ...
    def _stop_recording_frames(self):
        ...
        for cam in self._cam_widgets:
            ...
            cam.quit()
        save_synchronized_videos(video_recorders)
    ...
    def _reconstruct_3d_skeletons(self):
        ...
        this_session_orchestrator = SessionPipelineOrchestrator(session_id=APP_STATE.session_id)
        ...
        this_session_orchestrator.mediapipe2d_numCams_numFrames_numTrackedPoints_XY = load_mediapipe2d_data(APP_STATE.session_id)

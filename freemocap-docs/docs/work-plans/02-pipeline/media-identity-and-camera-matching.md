...
[client playback design](../archive/client-playback-design.md).
...
First complete the [client playback design](../archive/client-playback-design.md) review and prototype:

...
class CalibrationPipelineConfig(BaseModel):
    ...
    charuco_square_length: float = Field(gt=0, default=54, alias="charucoSquareLength",
                                         description="Length of one side of a black square on teh charuco board, default unit: mm")

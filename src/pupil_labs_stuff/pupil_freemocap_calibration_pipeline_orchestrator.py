...
from src.pupil_labs_stuff.pupil_freemocap_synchronizer import PupilFreemocapSynchronizer
from src.pupil_labs_stuff.qt_gl_laser_skeleton_visualizer import QtGlLaserSkeletonVisualizer
from src.pupil_labs_stuff.rotation_matrix_calculator import RotationMatrixCalculator
from src.pupil_labs_stuff.session_data_loader import SessionDataLoader
from src.pupil_labs_stuff.vor_calibrator import VorCalibrator
...
if __name__ == "__main__":
    ...
    data_path = Path("D:/Dropbox/FreeMoCapProject/FreeMocap_Data/old/")

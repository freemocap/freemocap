...
[`../09-standard-stream-protocol.md`](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels) (the single authority
...
what the solver tests catch — cross-link to [`../14`](../streaming-compatibility-specs/14-engine-testing-strategy.md)).

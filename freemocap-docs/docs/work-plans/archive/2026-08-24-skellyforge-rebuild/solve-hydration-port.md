...
2-point swing+twist suffered (see [kinematics-engine.md](kinematics-engine.md) + [ontology.md](../2026-08-17-message-model-cutover/ontology.md)).
...
- Ontology (seven layers + two faces): [ontology.md](../2026-08-17-message-model-cutover/ontology.md).

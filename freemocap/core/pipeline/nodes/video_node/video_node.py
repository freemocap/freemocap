...
class VideoNode:
    ...
    def create(cls,
        ...
        worker = multiprocessing.Process(target=cls._run,
                                         name=f"VideoProcessingNode-{camera_id}",
            ...
            while ipc.should_continue and not shutdown_self_flag.value:
                ...
                if not process_frame_number_subscription.empty():
                    ...
                    if config.calibration_task_config.live_track_charuco:
                        ...
                        #         camera_calibrator = SingleVideoCalibrator.from_charuco_observation(
                        #             camera_id=camera_id,
                    ...
                    # logger.debug(
                    #     f"Video {camera_id} processed frame {frame_rec_array.frame_metadata.frame_number[0]} in "

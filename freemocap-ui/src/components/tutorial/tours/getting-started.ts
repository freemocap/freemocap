...
export const gettingStartedTour: Tour = {
    ...
    steps: {
        ...
        'realtime-pipeline': {
            ...
            deeper: 'realtime-pipeline.1',
            next: 'calibration',
        },
        // ── Realtime-pipeline sub-tour (steps 4.1, 4.2) — rejoins at calibration.
        'realtime-pipeline.1': {
            id: 'realtime-pipeline.1',
            parentStepId: 'realtime-pipeline',
            kind: 'pointer',
            route: '/streaming',
            target: '[data-onboarding="realtime:pipeline"]',
            position: 'pos-bottom-right',
            titleKey: 'tour.realtimeDeep.controls.title',
            textKey: 'tour.realtimeDeep.controls.text',
            next: 'realtime-pipeline.2',
        },
        'realtime-pipeline.2': {
            id: 'realtime-pipeline.2',
            parentStepId: 'realtime-pipeline',
            kind: 'pointer',
            route: '/streaming',
            target: '[data-onboarding="realtime:pipeline"]',
            position: 'pos-bottom-right',
            titleKey: 'tour.realtimeDeep.recording.title',
            textKey: 'tour.realtimeDeep.recording.text',
            next: 'calibration',
        },
        calibration: {
            id: 'calibration',

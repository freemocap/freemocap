...
const ToggleComponent: React.FC<ToggleProps> = ({
  ...
  return (
    <div
      className={`min-w-full button toggle-button gap-1 p-1 br-1 flex justify-content-space-between items-center h-25 ${className} ${disabled ? "disabled" : ""}`}
    ...
    >
      <div className="text-container overflow-hidden flex items-center gap-1">
        ...
        <p className={clsx("text text-nowrap text-left md", toggled && "color-white")}>
          {text}
        </p>
      </div>

...
const RecordingPlaybackSession: React.FC = () => {
    ...
    return (
        <div className="playback-mode-main-container flex flex-col flex-1 min-h-0 pos-rel">
            <GridSettingsOverlay
                settings={settings}
...
export default RecordingPlaybackSession;

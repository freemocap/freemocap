...
interface ProcessingDirectorySettingsProps {
    open: boolean;
    onClose: () => void;
}
...
const ProcessingDirectorySettings: React.FC<
    ProcessingDirectorySettingsProps
> = ({ open, onClose }) => {
...
export default ProcessingDirectorySettings;

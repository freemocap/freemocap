...
from freemocap.zzold.core_processes.export_data.blender_stuff.export_to_blender.methods.ajc_addon.get_numpy_path import (
    get_numpy_path,
)
from freemocap.zzold.core_processes.export_data.blender_stuff.export_to_blender.methods.ajc_addon.install.install_ajc_addon import (
    install_ajc_addon,
)
from freemocap.zzold.core_processes.export_data.blender_stuff.export_to_blender.methods.ajc_addon.run_simple import \
    run_simple
...
def run_ajc_blender_addon_subprocess(
    ...
    ajc_addon_main_file_path = Path(__file__)#inspect.getfile(run_as_main_function)

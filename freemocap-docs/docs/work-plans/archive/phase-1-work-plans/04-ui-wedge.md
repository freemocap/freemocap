...
>
> Channel content is defined in [09 § channels](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels); the TypeScript
> types here **mirror** it and must never diverge from it. Terms — *keypoint* / *landmark* / *segment* —
> per [13](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md#two-kinds-of-trajectory).
>

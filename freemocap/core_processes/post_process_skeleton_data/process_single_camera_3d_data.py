...
from freemocap.core_processes.capture_volume_calibration.triangulate_3d_data import save_mediapipe_skeleton_data_to_npy
from freemocap.utilities.project_3d_data_to_z_plane import project_3d_data_to_z_plane

logger = logging.getLogger(__name__)


def process_single_camera_skeleton_data(input_image_data_frame_marker_xyz: np.ndarray, raw_data_folder_path: Union[str, Path], project_to_z_plane:bool=True):

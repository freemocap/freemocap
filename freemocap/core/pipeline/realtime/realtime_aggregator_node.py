...
class RealtimeAggregatorNode(AggregatorNode):
    ...
    def _run(
        ...
        timer = PipelineStageTimer(name=f"AggregatorNode-{camera_group_id}", start_time=timing_start_time, flush_interval=flush_interval) if log_pipeline_times else None

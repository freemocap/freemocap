...
from freemocap_web.core.config import PostProcessing
...
def post_process_data(post_processing_config: PostProcessing, raw_skel3d_frame_marker_xyz: np.ndarray):
    filter_sampling_rate = post_processing_config.frame_rate
    filter_cutoff_frequency = post_processing_config.butterworth_filter_parameters.cutoff_frequency
    filter_order = post_processing_config.butterworth_filter_parameters.order

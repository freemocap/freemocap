...
> layout in [09](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels) is the target, and the keypoint/landmark split
...
- The schema declares the six channel groups of [09](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels):
...
## Channel content — deferred to [09](../streaming-compatibility-specs/09-standard-stream-protocol.md)

> **Revised 2026-08-12 (FMC-SR §2).** This plan previously carried its own enumeration of the channel
> groups. It drifted from [09](../streaming-compatibility-specs/09-standard-stream-protocol.md) and then became the de-facto authority,
...
>
> **[09 § channels](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels) is the single authority on channel content.**
...
[07](../streaming-compatibility-specs/07-coordinate-conventions.md#the-local-rotation-trap-vmc-and-unreal) warns about, and an enum member
kept "for backward-compat during transition" contradicts the zero-backwards-compat rule in
[00](../streaming-compatibility-specs/00-overview.md) — there is no shipped wire format to be compatible with. Wire values follow 09's
group order.
...
`channels` — content per [09 § channels](../streaming-compatibility-specs/09-standard-stream-protocol.md#channels):

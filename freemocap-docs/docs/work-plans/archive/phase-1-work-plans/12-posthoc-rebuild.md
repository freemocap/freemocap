...
- The parquet/tidy serialization rework ([`../10`](../streaming-compatibility-specs/10-serialization-and-tidy-format.md)) — its own
  later plan.
...
- Re-read the Phase-D progress entries in
  `../IMPLEMENTATION_PLAN.md` (unavailable historical reference: `../IMPLEMENTATION_PLAN.md`) for what already converged (the de Leva

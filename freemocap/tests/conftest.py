...
calibration_toml_path = find_calibration_toml_path(sample_session_folder_path)
process_recording_headless(
    recording_path=sample_session_folder_path, path_to_camera_calibration_toml=calibration_toml_path
)
...
def raw_skeleton_npy_file_path():
    return find_raw_skeleton_npy_file_name(find_data_folder_path(sample_session_folder_path))

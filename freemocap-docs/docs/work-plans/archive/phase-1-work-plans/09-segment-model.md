...
>
> **This supersedes the keypoint→landmark framing.** [`13`](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md) declared
...
3. **One declaration, evaluated twice** — T-pose reference geometry and live per-frame pose. This is the
   property [`13`](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md) already states for `anatomical_offset`,
...
[`13`](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md) / defect D24.)
...
- [x] **Step 6:** Write `test_hierarchy_accessors_agree` — `segment_parents`, children, and
      root-to-segment chains describe the same tree ([`14`](../streaming-compatibility-specs/14-engine-testing-strategy.md) §7).
...
- [x] **Step 5:** Write the twist tests: a declared twist keypoint resolves a known roll (off-axis
      ...
      **threshold boundary** behaviorally (`test_singularity_gate_threshold_boundary` — fixtures that
      ...
      load-bearing contract test** ([`14`](../streaming-compatibility-specs/14-engine-testing-strategy.md) §4): `test_identity_at_t_pose`
...
- [ ] **Step 1:** Rewrite [`13`](../streaming-compatibility-specs/13-tracker-to-canonical-mapping.md) as the keypoint → segment
      reference-geometry boundary, and re-declare it SSOT for the surviving vocabulary
      (**keypoint** / **segment**; *landmark* retired).
- [ ] **Step 2:** [`00`](../streaming-compatibility-specs/00-overview.md) § Glossary — the four-load-bearing-terms table.
- [ ] **Step 3:** [`01`](../streaming-compatibility-specs/01-canonical-data-model.md) § what the frame carries — the landmark row.
- [ ] **Step 4:** [`12`](../streaming-compatibility-specs/12-standard-human-model.md) — § *Marker → bone retarget* becomes *what defines
...
- [ ] **Step 8:** `IMPLEMENTATION_PLAN` (unavailable historical reference: `../IMPLEMENTATION_PLAN.md`) — progress log entry + scope.
...
- No test passes under both operand orders, both handedness conventions, or both component orders
  ([`14`](../streaming-compatibility-specs/14-engine-testing-strategy.md)).

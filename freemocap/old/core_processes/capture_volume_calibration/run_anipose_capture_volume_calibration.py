...
from freemocap.old.core_processes.capture_volume_calibration.anipose_camera_calibration.anipose_camera_calibrator import (
...
def run_anipose_capture_volume_calibration(
    ...
    toml_path, groundplane_success = anipose_camera_calibrator.calibrate_camera_capture_volume(
        pin_camera_0_to_origin=pin_camera_0_to_origin, use_charuco_as_groundplane=use_charuco_as_groundplane
    )

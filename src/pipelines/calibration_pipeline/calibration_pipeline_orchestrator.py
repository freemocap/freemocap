...
class CalibrationPipelineOrchestrator:
    def __init__(
        ...
        if session_id is None:
            ...
            self._session_id = (
                session_id  # add calibration folder to "full" session folder
            )
                ...
                while should_continue:
                    ...
                    for (
                        ...
                        if save_video_in_frame_loop:
                            ...
                            this_open_cv_camera.video_recorder.save_frame_payload_to_video_file(
    ...
    def run_anipose_camera_calibration(
        self,
    ...
    def load_calibration_from_session_id(self, session_id: str):
        ...
        if Path(session_calibration_file_path).is_file():
            return freemocap_anipose.CameraGroup.load(

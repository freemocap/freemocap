...
The canonical endpoint reference is the [API Boundary](/docs/architecture/api-boundary) page; SkellyCam's `/skellycam/*` routes are documented in the [SkellyCam docs](https://freemocap.github.io/skellycam/). Below is a compact route sketch and the planned API redesign.

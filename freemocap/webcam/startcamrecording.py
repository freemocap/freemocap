...
class CamRecordingThread(threading.Thread): 
    ...
    def run(self):
        ...
        self.timeStamps = CamRecording(self.camID, self.camInput, self.videoName,self.rawVidPath,self.beginTime,self.parameterDictionary)
    def getStamps(self):
        return self.timeStamps
#the recording function that each threaded camera object runs
def CamRecording(camID, camInput, videoName,rawVidPath,beginTime,parameterDictionary):

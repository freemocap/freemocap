...
class CameraNode(SourceNode):
    ...
    def _run(
        ...
        if log_pipeline_times:
            timer = PipelineStageTimer(name=f"CameraNode-{camera_id}", start_time=timing_start_time or time.perf_counter(), flush_interval=flush_interval)

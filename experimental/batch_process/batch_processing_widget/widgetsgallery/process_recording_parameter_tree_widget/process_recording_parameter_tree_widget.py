...
class ProcessRecordingParameterTreeWidget(QWidget):
    ...
    def _create_process_parameters_widget(self):
        ...
        self._parameter_group = self._add_parameters_to_parameter_tree_widget(
            ...
            recording_processing_parameter_model=self._recording_processing_parameter_model,
        )
    ...
    def _add_parameters_to_parameter_tree_widget(
        ...
        parameter_group = self._convert_recording_processing_parameter_model_to_parameter_group(
    ...
    def _convert_recording_processing_parameter_model_to_parameter_group(
        self,
    ...
    def _create_recording_parameter_model(
        self,
    ) -> ProcessingParameterModel:
    ...
    def _launch_process_motion_capture_data_thread_worker(self):
        ...
        session_parameter_model = self._create_recording_parameter_model()

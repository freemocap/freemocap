...
from freemocap.system.paths_and_filenames.file_and_folder_names import (
    ...
    RAW_FULL_REPROJECTION_ERROR_NPY_FILE_NAME,
    RAW_REPROJECTION_ERROR_NPY_FILE_NAME,
    REPROJECTION_FILTERED_3D_NPY_FILE_NAME,
    REPROJECTION_FILTERED_FULL_REPROJECTION_ERROR_NPY_FILE_NAME,
    REPROJECTION_FILTERED_REPROJECTION_ERROR_NPY_FILE_NAME,
)
...
def save_3d_data_to_npy(
    ...
    if processing_level == "raw":
        data_3d_save_path = path_to_folder_where_data_will_be_saved / RAW_3D_NPY_FILE_NAME
        reprojection_error_save_path = (
            path_to_folder_where_data_will_be_saved / RAW_REPROJECTION_ERROR_NPY_FILE_NAME
        )
        full_reprojection_error_save_path = (
            path_to_folder_where_data_will_be_saved / RAW_FULL_REPROJECTION_ERROR_NPY_FILE_NAME
        )
    elif processing_level == "reprojection_filtered":
        data_3d_save_path = (
            path_to_folder_where_data_will_be_saved / REPROJECTION_FILTERED_3D_NPY_FILE_NAME
        )
        reprojection_error_save_path = (
            path_to_folder_where_data_will_be_saved / REPROJECTION_FILTERED_REPROJECTION_ERROR_NPY_FILE_NAME
        )
        full_reprojection_error_save_path = (
            path_to_folder_where_data_will_be_saved / REPROJECTION_FILTERED_FULL_REPROJECTION_ERROR_NPY_FILE_NAME
        )
    else:

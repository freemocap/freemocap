...
`rotation_quaternion.py`, `critically_damped_orientation.py`, `rigid_point_set.py`.
**Salvage:** [`archive/streaming-compatibility-specs/11-kinematics-fold-in.md`](../../streaming-compatibility-specs/11-kinematics-fold-in.md),
[`14-engine-testing-strategy.md`](../../streaming-compatibility-specs/14-engine-testing-strategy.md),
[`archive/phase-1-work-plans/05-kinematics-foldin-rotations.md`](../../phase-1-work-plans/05-kinematics-foldin-rotations.md).

...
> verbatim under [`archive/`](index.md) — they are history, not guidance. These docs and the code
...
| # | Layer | Covers |
|---|-------|--------|
| **00** | [foundation/](../00-foundation/index.md) | Conventions (frames, units, quaternions, mirroring), the vocabulary, testing philosophy. |
| **01** | [data-model/](../01-data-model/index.md) | The skeleton structures: component YAMLs + loader, rest-pose reference geometry, tracker→landmark mappings, the message contract. |
| **02** | [pipeline/](../02-pipeline/index.md) | The engine: math kernel + solve, the biomechanics layer, model-scale fitting, the realtime loop, the posthoc path. |
| **03** | [transport/](../03-transport/index.md) | The wire: protocol, backend relay, hub + adapters, HTTP control plane, on-disk serialization. |
| **04** | [ui/](../04-ui/index.md) | The frontend: TransportService dispatch, client homes, renderers. |

...
charuco_board_object = cv2.aruco.CharucoBoard_create(number_of_squares_width, number_of_squares_height, black_square_side_length, aruco_marker_length_proportional, aruco_marker_dict)

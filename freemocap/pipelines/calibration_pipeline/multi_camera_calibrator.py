...
class MultiCameraCalibrator(BaseModel):
    ...
    def add_observations_to_single_camera_calibrators(self, camera_node_output_by_camera: dict[
    ...
    #     camera_matricies = {camera_id: calibrator.camera_matrix for camera_id, calibrator in
    #                         self.single_camera_calibrators.items()}
    #
    #
    #     mc_calibrator = SparseBundleAdjustmentOptimizer.create(camera_matricies=camera_matricies,
    #                                                            input_2d_observations_by_camera=self.shared_view_accumulator.to_image_points_by_camera())

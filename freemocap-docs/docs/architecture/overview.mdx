...
FreeMoCap builds on two sibling projects, each with its own docs site:
[**SkellyCam**](https://freemocap.github.io/skellycam/) (the camera backend) and
[**SkellyTracker**](https://freemocap.github.io/skellytracker/) (the pose-estimation backend).
